#!/usr/bin/env python3
#
# https://www.topcoder.com/stat?c=problem_statement&pm=1259
#
...
# 1,7,4,5,5 are not zig-zag sequences, the first because its first two differences
...
# subsequence of sequence that is a zig-zag sequence. A subsequence is obtained by
