#!/usr/bin/env python3
#
# https://www.topcoder.com/stat?c=problem_statement&pm=2402
#
# Problem Statement
...
# well. Unfortunately, the town's well is in disrepair and needs to be restored. You
...
# nobody is willing to contribute to a fund to which his neighbor has also
# contributed. Next-door neighbors are always listed consecutively in donations,
# except that the first and last entries in donations are also for next-door
# neighbors. You must calculate and return the maximum amount of donations that can
# be collected.
#
# Definition
# Class:	BadNeighbors
...
# { 10, 3, 2, 5, 7, 8 }
# Returns: 19
# The maximum donation is 19, achieved by 10+2+7. It would be better to take 10+5+8
# except that the 10 and 8 donations are from neighbors.
#
# 1)
# { 11, 15 }
# Returns: 15
